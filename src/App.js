        ...
        return <div className="App">
                <ErrorBoundary>
                    <section className="App-header">
                            <button title={this.state.sideBarOpen ? "Close Menu" : "Open Menu"}
                                    onClick={this.clickHamburger}>
                                <FontAwesomeIcon icon="dog" flip={this.state.sideBarOpen ? "horizontal" : ""}
                                                 size="lg"/>
                            </button>
                        ...
                        <section className={this.state.sideBarOpen ? "App-mapView" : "App-mapView-expanded"}>
                            <MapView handleMarkerOpen={this.handleMarkerOpen}
                                     ...
                                     googleMapURL={'https://maps.googleapis.com/maps/api/js?key=AIzaSyBRQdKl46-TQJvyTgz_84HH_3cEn4dSwB8SHIT&v=3.exp'}
